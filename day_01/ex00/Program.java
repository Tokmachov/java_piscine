...
public class Program {
    public static void main(String[] av) {
        ...
        System.out.println("---Attempt to set credit transaction to positive transfer amount (Incorrect)---");
        transactionFour.setTransferAmount(999);
        System.out.println("Transaction amount : " + transactionFour.getTransferAmount());
        
        System.out.println("---Attempt to set debit transaction to negative transfer amount (Incorrect)---");
        transactionTwo.setTransferAmount(-999);
        System.out.println("Transaction amount : " + transactionOne.getTransferAmount());
    }
}